...
r,c,s,nf,letters,answer,letterlist,n,way=int(inputlist[0]),int(inputlist[1]),int(inputlist[2]),inputlist[4:len(inputlist)],["A","C","D"],"",[],[],""
if(s%c==0):
    way="start_right"
else:
    way="start_left"   
    ...
    def isLegal(self):
        ...
        if(self.way=="start_left"):
            if(self.getNextStartPoint()-1>=1 and getCol(self.getNextStartPoint()-1)==getCol(self.getNextStartPoint()-2)):
                ...
                isLe=False
            if(( ((self.getNextStartPoint()-1)%c==0 and self.le=="D") or (self.getNextStartPoint()-2)%c==1 and self.le=="C")):
                isLe=False
        else:
            if(self.getNextStartPoint()+1>=1 and getCol(self.getNextStartPoint()+1)==getCol(self.getNextStartPoint()+2)):
                pass
                ...
                isLe=False
            if((self.getNextStartPoint()+1)%c==1 and self.le=="C"):
